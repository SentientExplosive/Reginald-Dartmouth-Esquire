...
#ifndef INTERFACES__MSG__DETAIL__MOTOR_CONTROL__FUNCTIONS_H_
#define INTERFACES__MSG__DETAIL__MOTOR_CONTROL__FUNCTIONS_H_
 ...
 * )) before or use
 * interfaces__msg__MotorControl__create()
 ...
 * calls
 * interfaces__msg__MotorControl__init().
...
/**
 * It calls
 * interfaces__msg__MotorControl__fini()
 ...
 * interfaces__msg__MotorControl__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * interfaces__msg__MotorControl__Sequence__fini()
 * on the array,
...
#endif  // INTERFACES__MSG__DETAIL__MOTOR_CONTROL__FUNCTIONS_H_
